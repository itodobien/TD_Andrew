            ...
            if (_sounds.showAdvancedSettings) {
                ...
                if (_sounds.vrSettingsExpanded) {
                    ...
                    if (!SpatializerHelper.IsSupportedSpatializer) {
                        DTGUIHelper.ShowLargeBarAlert("You must select a supported Spatializer Plugin on the Audio Settings dialog before settings here will have any effect. Oculus, Resonance Audio and Steam Audio are currently supported.");
                    }
